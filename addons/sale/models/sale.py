...
class SaleOrder(models.Model):
    ...
    def _compute_partner_information(self):
        print("compute partner information")
        for order in self:
...
class SaleOrderLine(models.Model):
    ...
    def _compute_price_unit(self):
        for line in self:
            ...
            if line.product_id and line.product_uom:
                ...
                discount = 0.0
                if line.order_id.pricelist_id.discount_policy == "without_discount" and line.user_has_groups("product.group_discount_per_so_line"):
                    ...
                    if new_list_price != 0:
                        if line.currency_id != currency:
                            ...
                            new_list_price = currency._convert(
                                ...
                                line.company_id or line.env.company, line.order_id.date_order or fields.Date.today())
    ...
    def _product_id_warning(self):
        ...
        result = {}
        warning = {}
        product = self.product_id.with_context(self.order_partner_id.lang)
