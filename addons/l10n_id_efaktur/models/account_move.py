...
class AccountMove(models.Model):
    ...
    def post(self):
        ...
        for move in self:
            if move.line_ids.tax_ids and move.partner_id.l10n_id_pkp and not move.l10n_id_efaktur_id and move.type == 'out_invoice':
    ...
    def _generate_efaktur(self, delimiter):
        output_head = self.filtered(lambda x: x.type == 'out_invoice')._generate_efaktur_invoice(delimiter)
