        ...
        this.data = {
            ...
            'mail.activity.type': {
                ...
                records: [
                    ...
                    { id: 4, name: "Exception", decoration_type: "warning", icon: "fa-exclamation-triangle"}
                ],
            },
            'mail.message': {
                fields: {
...
QUnit.test('kanban activity widget with an activity', async function (assert) {
    ...
    assert.hasClass($record.find('.o_activity_btn span'), "fa-clock", "should display correct activity icon");
