...
class PaymentPortal(http.Controller):
    ...
    def invoice_pay_form(self, acquirer_id, invoice_id, save_token='form', access_token=None, **kwargs):
        ...
        if request.env.user._is_public():
            save_token = 'form'  # we avoid to create a token for the public user
