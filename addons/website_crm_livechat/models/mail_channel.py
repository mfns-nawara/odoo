...
class MailChannel(models.Model):
    ...
    def _convert_visitor_to_lead(self, partner, channel_partners, key, email_from=False):
        ...
        lead = super(MailChannel, self)._convert_visitor_to_lead(partner, channel_partners, key, email_from)
