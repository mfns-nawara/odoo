...
class TestAccountBankStatement(AccountTestInvoicingCommon):
    ...
    def test_reconciliation_invoice_payment_state(self):
        ...
        self.assertRecordValues(test_invoice_1, [{'invoice_payment_state': 'in_payment'}])
        self.assertRecordValues(test_invoice_2, [{'invoice_payment_state': 'not_paid'}])
