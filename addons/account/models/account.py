...
class AccountTax(models.Model):
    ...
    def compute_all(self, price_unit, currency=None, quantity=1.0, product=None, partner=None, is_refund=False, handle_price_include=True):
        ...
        # Suppose two invoice lines: 27000 and 10920, both having a 19% tax included tax.
        #
        #                   Line 1                      Line 2
        # -----------------------------------------------------------------------
        ...
        #
        # If the rounding of the total_excluded is made only at the end, it could lead to some rounding issues
