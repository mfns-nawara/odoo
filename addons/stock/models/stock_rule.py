...
class StockRule(models.Model):
    ...
    def _get_stock_move_values(self, product_id, product_qty, product_uom, location_id, name, origin, company_id, values):
        ...
        move_values = {
            'name': name[:2000],
            'product_custom_attribute_values': values.get('product_custom_attribute_values'),
            ...
            'description_picking': product_id.get_product_multiline_description_sale() + values.get('product_custom_attribute_values'),
