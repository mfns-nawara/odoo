    ...
    def _compute_day_open(self):
        for applicant in self:
            if applicant.date_open:
                # VFE NOTE : Datetime.now needed when computed before record creation.
                date_create = applicant.create_date or fields.Datetime.now()
                # VFE TODO make date_open a compute stored readonly False.
