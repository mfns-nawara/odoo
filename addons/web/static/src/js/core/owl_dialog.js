odoo.define('web.OwlDialog', function (require) {
    ...
    class Dialog extends Component {
        ...
        static display(dialog) {
            ...
            const activeDialogEl = document.querySelector('.o_dialog.active');
            if (activeDialogEl) {
                activeDialogEl.classList.remove('active');
            }
            // Push dialog and update body class
            this.displayed.push(dialog);
            if (dialog instanceof this) {
                dialog.dialogRef.el.classList.add('active');
            }
        ...
        static hide(dialog) {
            ...
            if (lastDialog) {
                lastDialog.el.focus();
                if (lastDialog instanceof this) {
                    lastDialog.dialogRef.el.classList.add('active');
                }
                document.body.classList.add('modal-open');
            } else {
