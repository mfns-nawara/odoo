...
return AbstractRenderer.extend({
    ...
    getLocalState: function () {
        var $fcScroller = $(this.calendarElement).find('.fc-scroller');
        return {
     ...
     * @param fc4Event
     * @return {{allDay, color, attendees, record, start: (*|number), r_start: *, end: (*|number), id: *, title: *, r_end: *, reset_allday}}
     * @private
     */
    ...
    _initCalendar: function () {
        ...
        var fc_options = $.extend({}, this.state.fc_options, {
            ...
            height: 'parent',
            unselectAuto: false,
            dir: _t.database.parameters.direction, //TODO test
            locale: locale,
        });
